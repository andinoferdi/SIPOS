...
export default function NotificationDropdown() {
  ...
  return (
    <div className="relative">
      ...
      >
        <span
          className={`absolute right-0 top-0.5 z-10 h-2 w-2 rounded-full bg-[var(--token-orange-400)] ${
            !notifying ? "hidden" : "flex"
          }`}
        >
          <span className="absolute inline-flex w-full h-full bg-[var(--token-orange-400)] rounded-full opacity-75 animate-ping"></span>
        </span>
        <svg
      ...
      >
        <div className="flex items-center justify-between pb-3 mb-3 border-b border-[var(--token-gray-100)] dark:border-[var(--token-gray-700)]">
          ...
          <button
            ...
            className="text-[var(--token-gray-500)] transition dropdown-toggle dark:text-[var(--token-gray-400)] hover:text-[var(--token-gray-700)] dark:hover:text-[var(--token-gray-200)]"
          >
            <svg
              className="fill-current"
              width="24"
        ...
        <ul className="flex flex-col h-auto overflow-y-auto custom-scrollbar">
          ...
          <li>
            ...
            >
              <span className="relative block w-full h-10 rounded-full z-1 max-w-10">
                ...
                />
                <span className="absolute bottom-0 right-0 z-10 h-2.5 w-full max-w-2.5 rounded-full border-[1.5px] border-[var(--token-white)] bg-success-500 dark:border-[var(--token-gray-900)]"></span>
              </span>

              <span className="block">
                <span className="mb-1.5 space-x-1 block text-theme-sm text-[var(--token-gray-500)] dark:text-[var(--token-gray-400)]">
                  <span className="font-medium text-[var(--token-gray-800)] dark:text-[var(--token-white-90)]">
                    Terry Franci
                  </span>
                ...
                <span className="flex items-center gap-2 text-[var(--token-gray-500)] text-theme-xs dark:text-[var(--token-gray-400)]">
                  <span>Project</span>
                  <span className="w-1 h-1 bg-[var(--token-gray-400)] rounded-full"></span>
                  <span>5 min ago</span>
                </span>
              </span>
            </DropdownItem>
          ...
          <li>
            ...
            >
              ...
              <span className="block">
                <span className="mb-1.5 block space-x-1  text-theme-sm text-[var(--token-gray-500)] dark:text-[var(--token-gray-400)]">
                  <span className="font-medium text-[var(--token-gray-800)] dark:text-[var(--token-white-90)]">
                    Alena Franci
                  </span>
                  <span> requests permission to change</span>
            ...
            >
              <span className="relative block w-full h-10 rounded-full z-1 max-w-10">
                <Image
                  ...
                  className="w-full overflow-hidden rounded-full"
                />
                <span className="absolute bottom-0 right-0 z-10 h-2.5 w-full max-w-2.5 rounded-full border-[1.5px] border-[var(--token-white)] bg-error-500 dark:border-[var(--token-gray-900)]"></span>
              </span>
