      ...
      `}
        ...
        >
          ...
          <div className="dz-message flex flex-col items-center m-0!">
            ...
            <h4 className="mb-3 font-semibold text-[var(--token-gray-800)] text-theme-xl dark:text-[var(--token-white-90)]">
              {isDragActive ? "Drop Files Here" : "Drag & Drop Files Here"}
            </h4>

            <span className=" text-center mb-5 block w-full max-w-[290px] text-sm text-[var(--token-gray-700)] dark:text-[var(--token-gray-400)]">
