...
const MultiSelect: React.FC<MultiSelectProps> = ({
  ...
  return (
    <div className="w-full">
      <label className="mb-1.5 block text-sm font-medium text-[var(--token-gray-700)] dark:text-[var(--token-gray-400)]">
        {label}
      </label>
            ...
            <div className="mb-2 flex h-11 rounded-lg border border-[var(--token-gray-300)] py-1.5 pl-3 pr-3 shadow-theme-xs outline-hidden transition focus:border-brand-300 focus:shadow-focus-ring dark:border-[var(--token-gray-700)] dark:bg-[var(--token-gray-900)] dark:focus:border-brand-300">
              <div className="flex flex-wrap flex-auto gap-2">
                {selectedValuesText.length > 0 ? (
                    ...
                    >
                      ...
                      <div className="flex flex-row-reverse flex-auto">
                        <div
                          ...
                          className="pl-2 text-[var(--token-gray-500)] cursor-pointer group-hover:text-[var(--token-gray-400)] dark:text-[var(--token-gray-400)]"
                        >
                          <svg
                  ...
                  <input
                    ...
                    className="w-full h-full p-1 pr-2 text-sm bg-transparent border-0 outline-hidden appearance-none placeholder:text-[var(--token-gray-800)] focus:border-0 focus:outline-hidden focus:ring-0 dark:placeholder:text-[var(--token-white-90)]"
                    readOnly
                    value="Select option"
                  />
                )}
              ...
              <div className="flex items-center py-1 pl-1 pr-1 w-7">
                <button
                  ...
                  className="w-5 h-5 text-[var(--token-gray-700)] outline-hidden cursor-pointer focus:outline-hidden dark:text-[var(--token-gray-400)]"
                >
                  <svg
                ...
                {options.map((option, index) => (
                  <div key={index}>
                    ...
                    >
                      ...
                      >
                        <div className="mx-2 leading-6 text-[var(--token-gray-800)] dark:text-[var(--token-white-90)]">
                          {option.text}
                        </div>
                      </div>
                    </div>
