...
export const Hero = () => {
  return (
    <section className="relative overflow-hidden pb-20 pt-32 lg:pb-32 lg:pt-40" id="hero">
      <div className="pointer-events-none absolute inset-0 -z-10 bg-gradient-to-b from-soft-teal/50 to-card dark:from-slate-100 dark:to-background" />
      ...
      <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-8">
          <div className="z-10 flex flex-col gap-6 text-center lg:text-left">
            <div className="mx-auto inline-flex w-fit items-center gap-2 rounded-full border border-slate-200 bg-card px-3 py-1 shadow-sm lg:mx-0">
              <span className="h-2 w-2 animate-pulse rounded-full bg-teal-accent" />
              <span className="text-xs font-bold uppercase tracking-wide text-slate-700">New Version 2.0</span>
            </div>
            <h1 className="text-4xl font-extrabold leading-[1.15] tracking-tight text-slate-900 sm:text-5xl lg:text-6xl dark:text-slate-900">Effortless POS for <span className="bg-gradient-to-r from-primary to-teal-accent bg-clip-text text-transparent">Modern Hospitality</span></h1>
            <p className="mx-auto max-w-2xl text-lg leading-relaxed text-slate-600 lg:mx-0 dark:text-slate-600">Streamline operations, delight guests, and boost revenue with the POS designed for the future of hospitality. Beautifully simple, powerfully effective.</p>
            ...
            <div className="mt-6 flex items-center justify-center gap-4 text-sm text-slate-500 lg:justify-start dark:text-slate-500">
          ...
          <div className="perspective-container relative hidden lg:block">
            <div className="floating-card relative overflow-hidden rounded-[1.5rem] border border-slate-100 bg-card p-2 shadow-2xl">
              ...
              <div className="absolute -bottom-6 -left-6 flex items-center gap-3 rounded-2xl border border-slate-100 bg-card p-4 shadow-xl">
                ...
                <div><p className="text-xs text-slate-500">Daily Revenue</p><p className="text-lg font-bold text-slate-900 dark:text-slate-900">+$12,450</p></div>
              </div>
              <div className="absolute -right-4 -top-4 flex items-center gap-2 rounded-2xl border border-slate-100 bg-card p-3 shadow-xl">
                ...
                <span className="text-xs font-semibold text-slate-600 dark:text-slate-600">Online Staff</span>
              </div>
            </div>
          </div>
