    ...
    <section className="py-20">
      <div className="wrapper">
        <div className="max-w-[800px] mx-auto">
          <p className="text-(--token-gray-500) dark:text-(--token-gray-400) font-medium mb-2">
            Updated
            <span className="text-(--token-gray-800) ml-1 inline-block dark:text-(--token-white-90)">
              15 Jan, 2028
            </span>
          </p>
          <h2 className="mb-12 text-4xl font-semibold text-(--token-gray-800) dark:text-(--token-white-90)">
            Privacy Policy
          </h2>
          <div className="mb-6">
            <p className="text-(--token-gray-500) dark:text-(--token-gray-400) font-normal leading-6 mb-6">
            ...
            <p className="text-(--token-gray-500) dark:text-(--token-gray-400) font-normal leading-6">
          ...
          <div className="mb-6">
            <h2 className="mb-4 text-2xl dark:text-(--token-white-90) font-semibold text-(--token-gray-800)">
              Rights you have over your data
            </h2>
            <p className="text-(--token-gray-500) font-normal dark:text-(--token-gray-400) leading-6 mb-4">
              lineicons collects data about visits to lineicons.com.
            </p>
            <p className="text-(--token-gray-500) font-normal dark:text-(--token-gray-400) leading-6">
          ...
          <div className="mb-12">
            <h2 className="mb-4 text-2xl font-semibold text-(--token-gray-800) dark:text-(--token-white-90)">
              We grant refund if :
            </h2>
            <ul className="list-disc list-inside space-y-4">
              <li className="text-(--token-gray-500) dark:text-(--token-gray-400) font-normal leading-6 mb-4">
          ...
          <div className="mb-12">
            <h2 className="mb-4 text-2xl font-semibold dark:text-(--token-white-90) text-(--token-gray-800)">
