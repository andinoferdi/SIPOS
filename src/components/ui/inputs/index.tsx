...
export function InputGroup({
  ...
  return (
    <div className={groupClassName}>
      ...
      <Input id={id} {...props} />
      {error && <p className="text-[var(--token-red-500)] text-sm mt-1.5">{error}</p>}
    </div>
  );
}
    ...
    <div>
      ...
      <div className="relative mt-1.5">
        ...
        <button
          ...
          className="absolute right-4 top-1/2 -translate-y-1/2 cursor-pointer text-[var(--token-gray-500)] dark:text-[var(--token-gray-400)]"
