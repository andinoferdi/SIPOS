  ...
  return (
    ...
    >
      <div className="flex items-center justify-center min-h-screen p-4">
        ...
        <div
          className="fixed inset-0 bg-[var(--token-gray-800-80)] backdrop-blur-lg transition-opacity"
          aria-hidden="true"
          onClick={onClose}
        />
        ...
        >
          <div className="absolute top-0 right-0 pt-4 pr-4">
            <button
              onClick={onClose}
              type="button"
              className="bg-[var(--token-gray-100)] dark:bg-[var(--token-white-5)] dark:hover:bg-[var(--token-gray-700)] dark:text-[var(--token-gray-400)] hover:bg-[var(--token-gray-200)] rounded-full size-9 inline-flex items-center justify-center text-[var(--token-gray-500)]"
            >
          ...
          <div className="mt-3 text-left w-full">
            <h3 className="text-[30px] mb-2 leading-[38px] font-bold text-[var(--token-gray-800)] dark:text-[var(--token-white-90)]">
              {title}
            </h3>
            {description && (
              <p className="text-[var(--token-gray-500)] dark:text-[var(--token-gray-400)]">{description}</p>
            )}
            {children}
          </div>
        </div>
