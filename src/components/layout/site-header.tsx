    ...
    <Navbar mode="fixed" scrollThreshold={24}>
      <NavBody className="mx-auto h-auto w-full max-w-7xl px-5 py-3 sm:px-7 lg:py-4">
        ...
        <div className="relative z-10 flex items-center gap-2">
          ...
          <Link
            href="/login"
            className="inline-flex items-center rounded-lg border border-soft marketing-primary-button px-4 py-2 text-sm font-semibold transition-opacity"
          >
            Masuk ke SIPOS
          </Link>
        </div>
      ...
      <MobileNav className="mx-auto h-auto w-full max-w-7xl px-5 py-3 sm:px-7">
        ...
        >
          ...
          <div className="w-full border-t border-soft pt-3">
            <Link
              href="/login"
              className="block rounded-lg marketing-primary-button px-4 py-2.5 text-center text-sm font-semibold transition-opacity"
              onClick={() => setMobileMenuOpen(false)}
            >
              Masuk ke SIPOS
            </Link>
